                    ...
                    <AppContext.Consumer>
                        {({ cartProducts }) => {
                            ...
                            return products.length > 0 ? <div>
                                ...
                                <button onClick={this.goTOCheckOut} className="flex max-w-xs justify-center rounded-md bg-slate-700 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mt-3">
